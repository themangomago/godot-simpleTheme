...
[ext_resource path="res://assets/theme/images/radiounchecked.png" type="Texture" id=3]
[ext_resource path="res://assets/theme/images/unchecked.png" type="Texture" id=4]
[ext_resource path="res://assets/theme/images/off.png" type="Texture" id=5]
[ext_resource path="res://assets/theme/images/on.png" type="Texture" id=6]
[ext_resource path="res://assets/theme/images/icon_add.png" type="Texture" id=7]
[ext_resource path="res://assets/theme/images/color_picker_hue.png" type="Texture" id=8]
[ext_resource path="res://assets/theme/images/dummy.png" type="Texture" id=9]
[ext_resource path="res://assets/theme/images/nothing.png" type="Texture" id=10]
[ext_resource path="res://assets/theme/images/icon_color_pick.png" type="Texture" id=11]
[ext_resource path="res://assets/theme/images/icon_folder.png" type="Texture" id=12]
[ext_resource path="res://assets/theme/images/icon_parent_folder.png" type="Texture" id=13]
[ext_resource path="res://assets/theme/images/icon_reload.png" type="Texture" id=14]
[ext_resource path="res://assets/theme/images/grabber.png" type="Texture" id=15]
[ext_resource path="res://assets/theme/images/grabberDeactivated.png" type="Texture" id=16]
[ext_resource path="res://assets/theme/images/h_tick.png" type="Texture" id=17]
[ext_resource path="res://assets/theme/images/dropdown.png" type="Texture" id=18]
[ext_resource path="res://assets/theme/images/arrow_right.png" type="Texture" id=19]
[ext_resource path="res://assets/theme/images/arrow_down.png" type="Texture" id=20]
[ext_resource path="res://assets/theme/images/updown.png" type="Texture" id=21]
[ext_resource path="res://assets/theme/images/close.png" type="Texture" id=22]
[ext_resource path="res://assets/font18.tres" type="DynamicFont" id=23]
...
ColorPicker/icons/color_sample = ExtResource( 9 )
ColorPicker/icons/preset_bg = ExtResource( 10 )
ColorPicker/icons/screen_picker = ExtResource( 11 )
...
ColorPickerButton/icons/bg = ExtResource( 9 )
...
FileDialog/icons/folder = ExtResource( 12 )
FileDialog/icons/parent_folder = ExtResource( 13 )
FileDialog/icons/reload = ExtResource( 14 )
...
GraphEdit/icons/minus = ExtResource( 9 )
GraphEdit/icons/more = ExtResource( 9 )
GraphEdit/icons/reset = ExtResource( 9 )
GraphEdit/icons/snap = ExtResource( 9 )
...
GraphNode/icons/close = ExtResource( 9 )
GraphNode/icons/port = ExtResource( 9 )
GraphNode/icons/resizer = ExtResource( 9 )
...
HScrollBar/icons/decrement = ExtResource( 10 )
HScrollBar/icons/decrement_highlight = ExtResource( 10 )
HScrollBar/icons/increment = ExtResource( 10 )
HScrollBar/icons/increment_highlight = ExtResource( 10 )
...
HSlider/icons/grabber = ExtResource( 15 )
HSlider/icons/grabber_disabled = ExtResource( 16 )
HSlider/icons/grabber_highlight = ExtResource( 15 )
HSlider/icons/tick = ExtResource( 17 )
...
HSplitContainer/icons/grabber = ExtResource( 9 )
...
OptionButton/icons/arrow = ExtResource( 18 )
...
PopupMenu/icons/submenu = ExtResource( 19 )
...
VScrollBar/icons/decrement = ExtResource( 10 )
VScrollBar/icons/decrement_highlight = ExtResource( 10 )
VScrollBar/icons/increment = ExtResource( 10 )
VScrollBar/icons/increment_highlight = ExtResource( 10 )
...
VSlider/icons/grabber = ExtResource( 15 )
VSlider/icons/grabber_disabled = ExtResource( 16 )
VSlider/icons/grabber_highlight = ExtResource( 15 )
VSlider/icons/tick = ExtResource( 9 )
...
WindowDialog/icons/close = ExtResource( 22 )
WindowDialog/icons/close_highlight = ExtResource( 22 )
